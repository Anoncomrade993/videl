...
<body class="bg-white min-h-screen overflow-x-hidden">
		...
		<div class="w-full max-w-md mx-auto bg-white rounded-xl shadow-2xl overflow-hidden change-email-card">
			<div class="p-6 sm:p-8 md:p-10">
				...
				<div id="change-email-form" class="space-y-4 sm:space-y-6">
					<!-- Token Input -->
					<div>
						<input type="text" value="${kaf}" id="kaf" hidden>
						<input type="text" value="${token}" id="tkn" hidden>
					</div>
				</div>
				...
				<div>
					...
					<div class="relative">
						...
						<input type="password" id="password" required class="input-field pl-10 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500" placeholder="enter current password" minlength="8">
	...
	<script type="module" src="/client/change_email.js"></script>
</body>
