				...
				<div id="reset-password-form" class="space-y-4 sm:space-y-6">
					...
					<div>
						...
						<div class="relative">
							...
							<input type="password" id="confirm-password" required class="input-field pl-10 block w-full px-3 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-orange-500" placeholder="Confirm new password" minlength="8">
							<div class="absolute inset-y-0 right-0 pr-3 flex items-center">
							</div>
						</div>
